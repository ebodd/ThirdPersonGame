...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AGameMechanicsGameMode_Statics::Class_MetaDataParams[] = {
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_AGameMechanicsGameMode_Statics::ClassParams = {
		...
		0,
		0x008802A8u,
		METADATA_PARAMS(Z_Construct_UClass_AGameMechanicsGameMode_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_AGameMechanicsGameMode_Statics::Class_MetaDataParams))
	};
	UClass* Z_Construct_UClass_AGameMechanicsGameMode()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_AGameMechanicsGameMode_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(AGameMechanicsGameMode, 2584657439);
	template<> GAMEMECHANICS_API UClass* StaticClass<AGameMechanicsGameMode>()
	{
		return AGameMechanicsGameMode::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_AGameMechanicsGameMode(Z_Construct_UClass_AGameMechanicsGameMode, &AGameMechanicsGameMode::StaticClass, TEXT("/Script/GameMechanics"), TEXT("AGameMechanicsGameMode"), false, nullptr, nullptr, nullptr);
